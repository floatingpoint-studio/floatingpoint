...
const data = [
  {
    serviceimage:"./assets/Programming-pana.svg",
    title: "Web",
    // desc: `
  ...
  {
    serviceimage:"./assets/MobileAppDev.png",
    title: "App",
  ...
  {
    serviceimage:"./assets/DesignerGirl.png",
    title: "Graphics",
  ...
  str += `
    <div class="infocontainer bggrad">
      <div class="textholder">
        <div><img src="${item.serviceimage}" alt="" class="serviceimage"></div>
          <span class="infoheading">${item.title}</span>
      </div>
      <div class="serviceicons">
                <img src="${item.img[0]}" alt="" class="icons">
                <img src="${item.img[1]}" alt="" class="icons">
                <img src="${item.img[2]}" alt="" class="icons">
                <img src="${item.img[3]}" alt="" class="icons">
                <img src="${item.img[4]}" alt="" class="icons">
                <img src="${item.img[5]}" alt="" class="icons">               
      </div>
